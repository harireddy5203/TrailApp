 ...
 */
package com.harik.inno.security.access;

import org.springframework.security.core.Authentication;

import com.harik.inno.security.userdetails.IExtendedUserDetails;
...
public interface IPermissionEvaluator {
     ...
     *
     * @param userPrincipal
     *         Authenticated user of type {@link com.harik.inno.security.userdetails.IExtendedUserDetails}
     * @param permissionCode
     *         Unique identifier of the permission
     *
     * @return True if the current authenticated user has the permissions for the respective permission code else
