...
/**
 * Implementation that maps the "client" table in the database to an entity in the ORM world.
 *
 * @author Admin
 */
...
@Table(name = "client")
@Entity
public class ClientEntity extends AbstractIdGeneratedEntity<Integer> {
